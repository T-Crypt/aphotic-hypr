...
QtObject {
    ...
    readonly property QtObject palette: QtObject {
        readonly property color m3primary: "#A778A5"
        ...
        readonly property color m3error: "#5D566E"
        ...
        readonly property color m3outlineVariant: "#25232C"
        readonly property color m3surfaceContainer: "#0D0A13"
        readonly property color m3surfaceContainerHigh: "#2B2830"
