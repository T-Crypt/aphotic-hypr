...
// Matches the reference plugin's own ServiceConfig defaults where
// applicable. brightnessIncrement fixed from Task 2's int 5 to the real
// qreal 0.1 — Brightness is a 0-1 fraction (same shape as Audio's
// audioIncrement), so 5 was a step-count/fraction unit mismatch, not a
// deliberate choice.
QtObject {
