> **Archived 2026-08-30.** Design intent absorbed into [`docs/APHOTIC_UNIFIED_VISION.md`](../../APHOTIC_UNIFIED_VISION.md)'s Dev domain / Dashboard status (much of this shipped already — see `docs/LEDGER.md`'s 'Dashboard tabs are already shipped' note). Kept here as the original design doc.
